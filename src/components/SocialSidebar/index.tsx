...
export function SocialSidebar(): JSX.Element {
  return (
    <>
      <div className="md:fixed md:top-1/4 md:left-0 bg-[#121111] md:bg-transparent md:mx-0 md:py-2 md:px-4 p-4 md:flex-col flex-row justify-evenly items-center gap-4 md:border-2 border-[#FF020A] md:flex flex">
