  ...
  return (
    <>
      ...
      <div className="h-screen relative flex justify-center items-center flex-col gap-6 font-mono">
        ...
        <button
          className={`transition-[font-weight,letter-spacing] drop-shadow-2xl dark:text-white duration-300 hover:font-black font-bold hover:tracking-widest bg-white shadow-2xl dark:bg-black-elevation-1 dark:shadow-black-shadow dark:shadow-inner rounded-md py-4 px-8 text-lg`}
