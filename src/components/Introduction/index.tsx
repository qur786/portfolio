  ...
  return (
    <>
      ...
      <div className="h-screen relative flex justify-center items-center flex-col gap-6 font-mono">
        ...
        <button
          className={`transition-[font-weight,letter-spacing] text-white duration-700 hover:font-black font-light hover:tracking-widest bg-stone-500 dark:bg-stone-700 shadow-inner shadow-red-100/100 rounded-md py-4 px-8 text-lg`}
